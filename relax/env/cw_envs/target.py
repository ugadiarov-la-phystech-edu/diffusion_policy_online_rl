...
class CwTargetEnvGymnasium(gymnasium.Env):
    ...
    def __init__(self, obs_size, time_limit, render_mode, seed):
        assert render_mode == self.metadata['render.modes'][0]
        ...
        env_config['time_limit'] = time_limit
        env_config['obs_size'] = obs_size
